...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define WILLIAM		"WilliamStucchi"
#define GIADA		"GiadaSilvestrini"
#define FRANCESCOS	"FrancescoScorccarello"
#define FRANCESCOT	"FrancescoTranqillo"
#define PAOLO		"PaoloGalfano"
